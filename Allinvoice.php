          ...
          <table border="0" class="table table-sm " id="example">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <button type="button" name="view_details" class="btn btn-warning btn-xs " id="" 
                  onchange=getprice(this.value,".$prod['ord_no'].")>View</button>
                  <a href="deleteOrder.php?ord_no=<?php echo $prod['ord_no'];?>&operation=delete">
